        ...
        <div className='h-screen w-screen flex justify-center items-center '>
            <div className='flex flex-row w-7/12 h-2/3 rounded-xl border-2 border-gray-300 shadow-xl overflow-auto'>
                ...
                <div className='flex flex-col flex-1 justify-center items-center'>
                    <h1 className='uppercase font-semibold text-xl text-center my-4'>Sign Up</h1>
                    <Form className='mt-4'
                        name="basic"
                    ...
                    <p className='text-sm'>Already have an account? <Link to={"/login"} className='underline font-semibold p-2 hover:text-blue-500'>Sign in</Link></p>
                </div>
