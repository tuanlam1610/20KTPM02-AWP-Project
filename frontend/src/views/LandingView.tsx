        ...
        <div className='flex flex-col'>
            ...
            <div className='flex flex-col'>
                    ...
                    <div className='flex h-full'>
                        ...
                        <div className='h-full w-5/12 flex justify-center'>
                            <div className='w-3/4 h-full flex flex-col gap-2 justify-center items-start'>
                                <p className='text-xl text-indigo-500'>New Learning Experience At</p>
                                <h1 className='text-3xl uppercase font-semibold text-indigo-500'>HQL Education</h1>
                                <p className=' text-gray-700 italic mb-4'>Enrich your knowledge and get a head start into your next career.</p>
                                <Button className='px-12 py-6 rounded-full bg-indigo-500 flex justify-center items-center text-white hover:bg-white'>Contact Us</Button>
                            </div>
                        </div>
                        {/* Right Section */}
                        <div className='flex-1 bg-gray-400 overflow-hidden'>
                            <Carousel autoplay>
                                <div className='h-[80vh]'><img src={carouselImg1} alt="carousel1" className='h-full object-cover' /></div>
                                <div className='h-[80vh]'><img src={carouselImg2} alt="carousel2" className='h-full object-cover' /></div>
                                <div className='h-[80vh]'><img src={carouselImg3} alt="carousel3" className='h-full object-cover' /></div>
                            </Carousel>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col items-center gap-4 w-full mb-12'>
                    ...
                    <p className='text-base mb-8'>HQL is a platform that allows you to learn and grow your knowledge in various fields of study.</p>
                    {/* Horizontal View */}
                    <div className='flex w-9/12 mx-8 gap-8'>
                        {listContent.map((content, index) => (
                            ...
                            hover:shadow-xl hover:bg-indigo-100' >
                                ...
                                <p className='text-center text-sm text-gray-600'>{content.summary}</p>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className='flex justify-center w-2/3 gap-12 my-8'>
                        ...
                        <div className='py-8 '>
                            ...
                            <div className='flex gap-4'>
                                <Link to={"/"}>
                                    <Button className='h-8 w-8 text-lg text-indigo-300 bg-white flex justify-center items-center rounded-full'><GoogleOutlined /></Button>
                                </Link>
                                <Link to={"/"}>
                                    <Button className='h-8 w-8 text-lg text-indigo-300 bg-white flex justify-center items-center rounded-full'><LinkedinOutlined /></Button>
                                </Link>
                                <Link to={"/"}>
                                    <Button className='h-8 w-8 text-lg text-indigo-300 bg-white flex justify-center items-center rounded-full'><FacebookOutlined /></Button>
                                </Link>
                                <Link to={"/"}>
                                    <Button className='h-8 w-8 text-lg text-indigo-300 bg-white flex justify-center items-center rounded-full'><InstagramOutlined /></Button>
                                </Link>
                            </div>
                        </div>
                    </div>
