        ...
        <div className="flex flex-col flex-1 w-full justify-center items-center bg-white mt-4">
          <div className='mt-4 w-full min-w-fit'>
            ...
            <div className='h-1/3 flex justify-center items-center'>
              <img src={confirmImg} alt="confirmSuccessImg" className="object-contain box-border px-8 h-full" />
            </div>
            <p className='text-sm text-gray-500 text-center'>Your account is activated successfully. Please sign in again to join with us!</p>
            <div className='flex justify-center items-center my-4'>
              <Button className='flex justify-center items-center rounded-full w-2/3 px-6 py-4 bg-indigo-500 text-white hover:bg-white'
                onClick={() => {
                  navigate('/login')
                }}>Sign In</Button>
            </div>
